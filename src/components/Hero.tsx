...
<button
  ...
  className="absolute bottom-7 right-7 z-20 flex h-10 w-10 items-center justify-center rounded-full border border-ivory/40 text-ivory transition-all duration-300 hover:bg-ivory/10"
>
  {isMuted ? '🔇' : '🔊'}
</button>
