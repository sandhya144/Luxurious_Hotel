  ...
  {isMuted ? (
    ...
    <Volume2 className="h-5 w-5" />
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-6 text-center">
        ...
        >
          Located a 5-minute walk from Kashi Vishwanath Temple, our stay in Varanasi blends heartfelt hospitality with the comfort of home — so close to devotion, yet so far from the noise.
          </motion.p>
