  ...
  return (
    <main className="bg-ivory pt-28 md:pt-32">
      <Seo
        ...
        description="Our room types at The White House Hotel — Deluxe, Super Deluxe, Family Suite, Executive, and Temple View. Clean, comfortable, steps from Kashi Vishwanath Temple."
        path="/rooms"
      />
      <section className="py-16 md:py-20">
        <div className="mx-auto max-w-6xl px-6">
          <SectionHeading eyebrow="Four Rooms" title="Our Rooms, Each Kept Spotless">
